...
import pytest
from osod.tof.helpers import average_distance
from osod.tof import TofReadingSet


@pytest.fixture
def perfect_flat_reading() -> TofReadingSet:
...
@pytest.fixture
def oblique_reading() -> TofReadingSet:
...
def test_average_for_perfect_flat_reading(perfect_flat_reading: TofReadingSet):
    """ "average_distance should always average all provided readings"""
    assert average_distance(perfect_flat_reading) == 1000


def test_average_for_oblique_reading(oblique_reading: TofReadingSet):
    """ "average_distance should always average all provided readings"""
